/**
 * aiShuffleStore.js
 * Ephemeral Zustand store for AI shuffle server state.
 * NOT persisted to localStorage — server state is re-fetched each session.
 *
...
// ── Store ────────────────────────────────────────────────────────────────────
export const useAIShuffleStore = create((set, get) => ({
  // Server config
  serverUrl:    '',
  isConfigured: false,
